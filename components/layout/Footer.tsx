...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto pt-16 pb-8" style={{ borderTop: "0.5px solid rgba(200, 241, 53, 0.4)" }}>
      <div className="container">
            ...
            <div className="mt-1 flex gap-2">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-card text-accent no-underline transition-colors duration-200" style={{ border: "2px solid rgba(200, 241, 53, 0.3)" }} onMouseEnter={(e) => e.currentTarget.style.borderColor = "rgba(200, 241, 53, 0.6)"} onMouseLeave={(e) => e.currentTarget.style.borderColor = "rgba(200, 241, 53, 0.3)"}
                >
                  {icon}
                </a>
              ))}
        ...
        <div className="divider" style={{ background: "linear-gradient(to right, transparent, #c8f135, transparent)", opacity: 0.3, height: "0.5px" }} />
