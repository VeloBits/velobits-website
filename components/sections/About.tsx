        ...
        <div className="about-grid grid items-center gap-12 grid-cols-2 max-[1024px]:grid-cols-1 max-[1024px]:gap-10">
          <div className="flex flex-col gap-[1.4rem] pr-8">
            ...
            <div className="reveal reveal-delay-3 mt-2 grid grid-cols-3 gap-[0.8rem]">
              {stats.map((s, i) => (
                <div key={s.label} className="card relative p-[1.1rem] text-center border-2 border-[rgba(200,241,53,0.2)] transition-all duration-300 hover:border-[rgba(200,241,53,0.35)] hover:shadow-[0_8px_24px_rgba(200,241,53,0.1)]">
          ...
          <div className="about-visual flex items-center justify-center pl-8 max-[1024px]:hidden">
            <div className="relative h-[460px] w-[460px] shrink-0">
              ...
              <div className="absolute top-1/2 left-1/2 z-10 flex h-[90px] w-[90px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-2 border-accent bg-card shadow-[0_0_40px_rgba(200,241,53,0.28),0_0_0_8px_rgba(200,241,53,0.05)]">
                <Image src="/velobits-color-png.png" alt="Velobits" width={52} height={14} style={{ height: "auto", width: "auto" }} sizes="52px" className="w-[52px] drop-shadow-[0_0_6px_rgba(200,241,53,0.4)]" priority />
              </div>

              {/* ── Ring 1: glowing dots at r=108px ── */}
              {[
                { key: "r1a", anim: "animate-[orbit-reverse-lg_8s_linear_0s_infinite]",     solid: true },
                { key: "r1b", anim: "animate-[orbit-reverse-lg_8s_linear_-2.67s_infinite]", solid: false },
                { key: "r1c", anim: "animate-[orbit-reverse-lg_8s_linear_-5.33s_infinite]", solid: false },
              ].map(({ key, anim, solid }) => (
                <div key={key} className={`absolute top-1/2 left-1/2 h-[10px] w-[10px] -translate-x-[5px] -translate-y-[5px] ${anim}`}>
                  <div className={`h-full w-full rounded-full ${solid ? "bg-accent shadow-[0_0_8px_rgba(200,241,53,0.9)]" : "border border-[rgba(200,241,53,0.55)] bg-transparent"}`} />
                </div>
              ))}
              ...
              <div className="absolute top-1/2 left-1/2 h-[44px] w-[44px] -translate-x-[22px] -translate-y-[22px] animate-[orbit-lg_15s_linear_0s_infinite]">
                <div className="flex h-full w-full items-center justify-center rounded-full border-2 border-accent bg-[rgba(200,241,53,0.07)] shadow-[0_0_20px_rgba(200,241,53,0.3),0_4px_14px_rgba(0,0,0,0.5)] backdrop-blur-sm" title="FixMyText">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" stroke="rgba(200,241,53,0.95)" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" stroke="rgba(200,241,53,0.95)" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </div>
              ...
              <div className="absolute top-1/2 left-1/2 h-[44px] w-[44px] -translate-x-[22px] -translate-y-[22px] animate-[orbit-lg_15s_linear_-5s_infinite]">
                <div className="flex h-full w-full items-center justify-center rounded-full border-2 border-[rgba(140,80,220,0.7)] bg-[rgba(140,80,220,0.07)] shadow-[0_0_16px_rgba(140,80,220,0.25),0_4px_12px_rgba(0,0,0,0.5)] backdrop-blur-sm" title="Coming Soon">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                    <path d="M9 3h6M12 3v6.5m0 0L7 18a2 2 0 0 0 1.7 3h6.6A2 2 0 0 0 17 18l-5-8.5z" stroke="rgba(140,80,220,0.95)" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"/>
              ...
              <div className="absolute top-1/2 left-1/2 h-[44px] w-[44px] -translate-x-[22px] -translate-y-[22px] animate-[orbit-lg_15s_linear_-10s_infinite]">
                <div className="flex h-full w-full items-center justify-center rounded-full border-2 border-[rgba(255,255,255,0.2)] bg-[rgba(255,255,255,0.03)] shadow-[0_4px_12px_rgba(0,0,0,0.5)] backdrop-blur-sm" title="Suite">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                    <rect x="3" y="3" width="7" height="7" rx="1.5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.6"/>
                    <rect x="14" y="3" width="7" height="7" rx="1.5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.6"/>
                    <rect x="3" y="14" width="7" height="7" rx="1.5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.6"/>
                    <rect x="14" y="14" width="7" height="7" rx="1.5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.6"/>
                  </svg>
                </div>
              </div>
              ...
              <div className="absolute top-1/2 left-1/2 h-[40px] w-[40px] -translate-x-[20px] -translate-y-[20px] animate-[orbit-xl_24s_linear_0s_infinite]">
                <div className="flex h-full w-full items-center justify-center rounded-full border border-[rgba(200,241,53,0.5)] bg-[rgba(200,241,53,0.05)] text-[0.9rem] shadow-[0_0_12px_rgba(200,241,53,0.15)]" title="Community">💬</div>
              </div>
              ...
              <div className="absolute top-1/2 left-1/2 h-[36px] w-[36px] -translate-x-[18px] -translate-y-[18px] animate-[orbit-xl_24s_linear_-8s_infinite]">
                <div className="relative flex h-full w-full items-center justify-center rounded-full border border-[rgba(140,80,220,0.65)] bg-[rgba(140,80,220,0.06)] shadow-[0_0_12px_rgba(140,80,220,0.2)]" title="Vision">
              ...
              <div className="absolute top-1/2 left-1/2 h-[38px] w-[38px] -translate-x-[19px] -translate-y-[19px] animate-[orbit-xl_24s_linear_-16s_infinite]">
                <div className="flex h-full w-full items-center justify-center rounded-full border border-[rgba(255,255,255,0.22)] bg-[rgba(255,255,255,0.04)] text-[0.85rem] shadow-[0_4px_10px_rgba(0,0,0,0.4)]" title="Privacy">🔒</div>
              </div>

              {/* ── Scatter decorative elements ── */}
              {/* Zigzag top-right */}
              <svg className="absolute top-[52px] right-[-18px]" width="28" height="16" viewBox="0 0 28 16" fill="none">
                <path d="M0 12 L7 2 L14 12 L21 2 L28 12" stroke="rgba(200,241,53,0.5)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              {/* Cross left */}
              <svg className="absolute top-[115px] left-[4px]" width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M0 0L14 14M14 0L0 14" stroke="rgba(200,241,53,0.35)" strokeWidth="2" strokeLinecap="round"/>
              </svg>
              ...
              {/* Zigzag bottom-left */}
              <svg className="absolute bottom-[85px] left-[-12px]" width="22" height="13" viewBox="0 0 22 13" fill="none">
                <path d="M0 10 L5.5 1 L11 10 L16.5 1 L22 10" stroke="rgba(200,241,53,0.28)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              {/* Cross bottom-right */}
              <svg className="absolute bottom-[115px] right-[4px]" width="12" height="12" viewBox="0 0 12 12" fill="none">
                <path d="M0 0L12 12M12 0L0 12" stroke="rgba(200,241,53,0.28)" strokeWidth="1.8" strokeLinecap="round"/>
              </svg>
