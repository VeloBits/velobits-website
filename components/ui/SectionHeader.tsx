  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="label-mono text-subtle">{eyebrow}</span>
      </div>

      <h2 className="font-display text-[length:var(--text-4xl)] leading-[0.9] font-extrabold tracking-[-0.04em] text-balance text-foreground uppercase">
        {titleLines.map((line) => (
